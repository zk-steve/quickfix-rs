...
impl<A, S> ConnectionHandler for Acceptor<'_, A, S>
where
    A: ApplicationCallback,
    S: FfiMessageStoreFactory,
{
...
impl<A, S> SessionContainer for Acceptor<'_, A, S>
where
    A: ApplicationCallback,
    S: FfiMessageStoreFactory,
{
...
impl<A, S> Drop for Acceptor<'_, A, S>
where
    A: ApplicationCallback,
    S: FfiMessageStoreFactory,
{
